...
export default function Home() {
  return (
    <>
      ...
      <div className="w-11/12 max-w-5xl mx-auto mt-20 mb-20 p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm shadow-xl flex flex-col md:flex-row gap-8">
        <div className="md:w-1/3">
          <h2 className="text-3xl font-bold text-white sticky top-24">Frequently Asked Questions</h2>
        </div>
